...
description: Review a proposed Crime Empire milestone or substantial simulation/gameplay system before implementation. Use whenever Matt or Codex is choosing scope, validating a mechanic against canon, defining actor-neutral behavior, checking information boundaries, or writing falsifiable success criteria. Do not use for reviewing completed commits.
---
