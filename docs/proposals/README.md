...
| 9. Crime categories and strategic functions | PROPOSAL — NEEDS HUMAN RULING | `CRIME_AND_LOCATION_OPERATIONS.md` | Vocabulary, not an approved feature list. |
...
- `CRIME_AND_LOCATION_OPERATIONS.md` — expanded crime vocabulary, strategic functions, the shared
  operation direction, and the rule for when a top-down map earns its cost.
